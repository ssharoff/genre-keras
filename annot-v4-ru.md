...
Оценка текстов по их функциям также похожа на подход многомерного анализа текста (Biber, et al, 2009), который часто использует такие размерности как Argumentative, Narrative reporting, Information или Promotional persuasion.
