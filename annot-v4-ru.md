...
Иногда размечаемый текст не выглядит как текст для читателя (например, это спам, случайный набор слов или последовательность кодов или хэштегов). Таким текстам не следует присваивать никакой функции из этого списка.
